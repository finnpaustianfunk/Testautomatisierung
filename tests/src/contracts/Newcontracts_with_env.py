...
# API
CONTRACTS_ENDPOINT = "https://app.emil.de/u/0/policies#policy-grid={%22query%22:%22%22,%22orderBy%22:{%22id%22:%22createdAt%22,%22desc%22:true}}"
...
# Microsoft Graph Konfiguration (aus Umgebungsvariablen)
...
EMAIL_FROM = os.getenv("EMAIL_FROM", "f.paustian@funk-gruppe.de")
EMAIL_TO_STR = os.getenv("EMAIL_TO", "f.paustian@funk-gruppe.de")
...
if __name__ == "__main__":
    ...
    if TENANT_ID == "YOUR_TENANT_ID" or CLIENT_ID == "YOUR_CLIENT_ID" or CLIENT_SECRET == "YOUR_CLIENT_SECRET":
        print("FEHLER: Microsoft Graph Konfiguration ist nicht vollständig!")
        print("Bitte setzen Sie die Umgebungsvariablen TENANT_ID, CLIENT_ID und CLIENT_SECRET")
        print("Siehe README_Microsoft_Graph_Setup.md für Details")
        exit(1)
    
    print("Starte Contract Report Generation...")
    ...
    try:
        os.unlink(pdf_path)
        print("Temporäre PDF-Datei gelöscht")
    except Exception as e:
        print(f"Warnung: Konnte temporäre PDF-Datei nicht löschen: {e}")
